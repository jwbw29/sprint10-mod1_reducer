...
_[x] Create a forked copy of this project.
_[x] Clone your OWN version of the repository in your terminal
_[x] cd into the project base directory `cd web-module-project-reducer-pattern`
_[x] Download project dependencies by running `npm install` \*[x] Start up the app using `npm start`
...
> _Now that we can see our state, let's change allow the user to change it. Let's start with a simple pre-made action...adding one to our total._
...
- [x] There is a version of the calculator focuses on adding individual digits, rather than entire numbers. How do you imagine adding an individual digit to the total state?
